...
<nav class="bg-white/50 backdrop-blur-md text-white py-4 px-6 sticky top-0 w-full z-50 shadow-lg">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-y-8 gap-x-6">
            <!-- About Us -->
            <div>
                <h3 class="text-lg md:text-2xl font-semibold text-red-600 mb-4 md:text-left text-center">About Us</h3>
            ...
            <!-- Quick Links -->
            <div>
                <h3 class="text-lg md:text-2xl font-semibold text-red-600 mb-4 md:text-left text-center">Quick Links</h3>
                <ul class="space-y-2 md:text-left text-center">
                    <li><a href="/" class="flex md:justify-start justify-center items-center text-white hover:text-red-600"><i class="fas fa-home mr-2"></i>Home</a></li>
                    <li><a href="/about" class="flex md:justify-start justify-center items-center text-white hover:text-red-600"><i class="fas fa-info-circle mr-2"></i>About</a></li>
                    <li><a href="/events" class="flex md:justify-start justify-center items-center text-white hover:text-red-600"><i class="fas fa-calendar-alt mr-2"></i>Events</a></li>
                    <li><a href="/blogs" class="flex md:justify-start justify-center items-center text-white hover:text-red-600"><i class="fas fa-blog mr-2"></i>Blogs</a></li>
                    <li><a href="/contact" class="flex md:justify-start justify-center items-center text-white hover:text-red-600"><i class="fas fa-envelope mr-2"></i>Contact</a></li>
                </ul>
            </div>

            <!-- Social Media -->
            <div>
                <h3 class="text-lg md:text-2xl font-semibold text-red-600 mb-4 md:text-left text-center">Follow Us</h3>
                <div class="space-y-2 md:text-left text-center">
                    <a href="https://www.facebook.com" class="flex md:justify-start justify-center items-center text-white hover:text-blue-600"><i class="fab fa-facebook mr-3"></i>Facebook</a>
                    <a href="https://x.com/" class="flex md:justify-start justify-center items-center text-white hover:text-blue-400"><i class="fab fa-twitter mr-3"></i>Twitter</a>
                    <a href="https://www.instagram.com" class="flex md:justify-start justify-center items-center text-white hover:text-pink-500"><i class="fab fa-instagram mr-3"></i>Instagram</a>
                    <a href="https://ke.linkedin.com/" class="flex md:justify-start justify-center items-center text-white hover:text-blue-800"><i class="fab fa-linkedin mr-3"></i>LinkedIn</a>
                </div>
            </div>

            <!-- Contact Us -->
            <div>
                <h3 class="text-lg md:text-2xl font-semibold text-red-600 mb-4 md:text-left text-center">Contact Us</h3>
                <div class="space-y-2 md:text-left text-center">
                    ...
                    <p class="flex md:justify-start justify-center items-center text-gray-400">
                        ...
                        <a href="mailto:contact@alumni.com" class="text-white hover:text-red-600">contact@alumni.com</a>
                    </p>
                    <p class="flex md:justify-start justify-center items-center text-gray-400">
